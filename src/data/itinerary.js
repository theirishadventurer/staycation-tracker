...
export const ITINERARY = [
  ...
  // Friday Night — JRPG anchor → quick games → DKC2 closer (2h 15m total)
  { id: 'fri-n1', day: 'Friday', block: 'Late Night Block', time: 'Slot 1 (60m)', minutes: 60,
  ...
  { id: 'fri-n2', day: 'Friday', block: 'Late Night Block', time: 'Slot 2 (20m)', minutes: 20,
    title: 'Battleship', console: 'NES',
    vibe: 'Quick palate-cleanser — one round of grid hunting.',
    fact: 'Mindscape\'s 1993 NES port was one of the last NES games released in North America. The cart added a single-player campaign mode where you raid enemy harbors — far more than the board game offers.',
    tip: 'Place ships against the edges to limit the enemy\'s search pattern. In campaign mode, scout planes reveal a 3x3 grid — use them on suspicious dense regions.' },
  { id: 'fri-n3', day: 'Friday', block: 'Late Night Block', time: 'Slot 3 (25m)', minutes: 25,
    title: 'Wolfenstein 3D', console: 'SNES',
    vibe: 'First-person maze shooter — historical curiosity at 25m.',
    fact: 'Nintendo forced the SNES port to swap blood for sweat, dogs for rats, and remove all swastikas. id Software refused to do the changes themselves — Imagineer\'s port team handled the censorship.',
    tip: 'Hug walls and tap to peek around corners — enemies hit hard at range. Push every suspicious wall panel; secrets hide treasure rooms and shortcuts.' },
  { id: 'fri-n4', day: 'Friday', block: 'Late Night Block', time: 'Slot 4 (30m)', minutes: 30,
    title: 'Donkey Kong Country 2', console: 'SNES',
    vibe: 'Closer — Pirate Panic into Krow\'s Nest, hear Stickerbrush Symphony.',
